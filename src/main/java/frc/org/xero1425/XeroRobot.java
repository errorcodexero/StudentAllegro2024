...
public abstract class XeroRobot extends LoggedRobot {
    ...
    public void setContainer(RobotContainer container) {
    ...
    private void autoModeChooser() {
        if (chooser_ == null && automodes_.size() > 0) {
            ...
            tab.add("Auto Mode Selector", chooser_).withSize(2, 1).withWidget(BuiltInWidgets.kComboBoxChooser).withPosition(0, 0);
        }
